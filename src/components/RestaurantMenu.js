    ...
    <>
      <div className="menu">
        <div className="item-description-header">
          ...
          <p>
            {restaurant?.city}, {restaurant.sla.lastMileTravel} km
          </p>
          <h4><svg
          className="star"
            width="20"
      ...
      <div className="item-description-details">
        <ul>
          <li>
            ...
            <span>
              {" "}
              <strong>{restaurant.sla.deliveryTime} MINS</strong>
            </span>
          </li>
          ...
          <li>
            ...
            <span>
              {" "}
              <strong>{restaurant.costForTwoMessage}</strong>
            </span>
          </li>
